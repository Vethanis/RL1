...
void Image::Load(const LoaderMeta& meta, Image& x)
{
...
void Image::Free(const LoaderMeta& meta, Image& x)
{
    Assert(x.data);
...
void Image::Init(const LoaderMeta& meta, Image& x)
{
...
void Image::Shutdown(const LoaderMeta& meta, Image& x)
{
